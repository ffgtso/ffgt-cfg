...
class { 'ff_gln_gw::params':
  router_id => "10.255.0.11", # The id of this router, probably the ipv4 address
...
ff_gln_gw::bird4::ospf {
  'ospf-${mesh_code}':
    mesh_code => "ffgt",
    range_ipv4 => "10.255.0.0/16",
    ospf_peerings => "/root/ospf-peerings-gw01.yaml",
    have_ospf_peerings => "no",
    ospf_links    => "/root/ospf-links-gw01.yaml",
    have_ospf_links => "yes",
    ospf_type => "leaf",
    announce_rid => "no"
}
